...
public class ArticleListAdapter extends CursorRecyclerViewAdapter<ArticleListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final Cursor cursor) {
        ...
        Log.d(TAG,String.valueOf(cursor.getLong(ArticleLoader.Query.PUBLISHED_DATE)));
        holder.subtitleView.setText(String.valueOf(cursor.getLong(ArticleLoader.Query.PUBLISHED_DATE)));
